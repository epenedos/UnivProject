...
namespace CodeGenerator.DataGenerator
{
	/// <summary>
	...
	public class Dg
	{
		...
		public DataTable GetSPList(string connectionString)
		{
		...
		public SqlParameterCollection getSPParameters(string connectionString,string spname)
		{
		...
		public string genMethodCode(string methodname,string spname)
		{
			string tmpSQL="";
			SqlParameterCollection spc;
			spc = this.getSPParameters(this.connectionstring ,spname);
